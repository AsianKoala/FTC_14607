package org.firstinspires.ftc.teamcode.plswork.java.HelperClasses;
...
import static RobotUtilities.MyPosition.worldXPositionOld;
import static RobotUtilities.MyPosition.worldYPosition;
import static RobotUtilities.MyPosition.worldYPositionOld;
...
//        myLift.update();
    ...
    public void loop() {
        ...
        if(ButtonPress.isGamepad1_left_stick_button_pressed()){
            myLoadingSensors.disabled = !myLoadingSensors.disabled;
        }
...
//        telemetry.addLine("profile 8: " + tp8.getAverageTimePerUpdateMillis());
    ...
    private void updateLoadingSensorsIfNecessary() {
        ...
        //update the loading sensors only if they could be
        // seeing something
        if(myCollector.rollerState == Collector.rollerStates.forwards &&
            ...
            if(isAuto && Auto1.programStage == Auto1.progStates.goToCollectMore.ordinal()){
