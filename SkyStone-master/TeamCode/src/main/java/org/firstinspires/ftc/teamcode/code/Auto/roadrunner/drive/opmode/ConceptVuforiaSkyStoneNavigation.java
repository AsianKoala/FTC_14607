...
@TeleOp(name = "FIND THE THING (vuforia nav) ", group = "idk")
    ...
    public void runOpMode() {
        ...
        while (!isStarted()) {
            ...
            if (targetVisible) {
                ...
                if(i==0) {
                    oldX = translation.get(1);
                }
                i++;
                double xPosition = translation.get(1) / mmPerInch;
                telemetry.addData("etst", xPosition/mmPerInch);
