...
@Autonomous(name = "REAL Red Foundation", group = "Firefly")
public class RedFoundationEncoder extends LinearOpMode {
...
//        rotateToSquare(0, 0.2, 1);
        ...
        driveEncodersStrafeIMU(1000, 1000, -1000, -1000, 0.4, 0.4, -0.4, -0.4, 0.25, 6, 90, true);
