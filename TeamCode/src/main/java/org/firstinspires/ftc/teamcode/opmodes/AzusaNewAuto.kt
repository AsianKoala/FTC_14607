...
class AzusaNewAuto : BaseOpMode() {
    override fun startPose(): Pose = Pose(Point(0.0, 0.0), Angle(0.0, Angle.Unit.RAD))

    override fun onLoop() {
        PurePursuitController.gunToPosition(azusa, StopPathPoint("final", 25.0, 25.0, 8.0, Angle(45.0.toRadians, Angle.Unit.RAD)), 0.7)
